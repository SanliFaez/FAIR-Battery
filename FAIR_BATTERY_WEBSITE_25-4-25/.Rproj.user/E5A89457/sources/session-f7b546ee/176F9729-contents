...
![Battery_Schematic](Images/FullBatteryBluePrint.png) {width="20%}" **Fig. 1** A schematic example of a Redox Flow Battery. All components described in the legend can be found in every RFB. The V(V)/V(II) to V(IV)/V(III) redox reaction is used as an example.
